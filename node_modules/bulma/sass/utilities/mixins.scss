...
// Define variables directly (replace these with your actual values or calculations)
$delete-dimensions: 1.25rem;
$delete-background-l: 0%;  // Assuming this is a lightness value
$delete-background-alpha: 0.5;
$delete-color: white;  // Replace with actual value or variable

// Mixin to apply these variables
@mixin delete {
  // Use the variables
  width: $delete-dimensions;
  height: $delete-dimensions;
  background-color: rgba($delete-background-l, $delete-background-l, $delete-background-l, $delete-background-alpha);
  color: $delete-color;
}
